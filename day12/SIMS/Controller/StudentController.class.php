...
final class StudentController extends BaseController
{
    public function index()
    {
        ...
        //包含学生首页视图文件
        include "./View/Student/StudentIndexView.html";
    }
    public function edit()
    {
        ...
        //包含修改的视图文件
        include "./View/Student/StudentEditView.html";
    }
...
//            die();
        ...
        {
            $this->jump("id={$id}的记录删除失败","?c=Student");

        }
    }
    public function add()
    {
        include "./View/Student/StudentAddView.html";
    }
