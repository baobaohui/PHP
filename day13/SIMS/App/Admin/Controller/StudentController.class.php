...
final class StudentController extends BaseController
{
    public function index()
    {
        ...
        //包含学生首页视图文件
        include "./App/Admin/View/Student/StudentIndexView.html";
    }
    public function edit()
    {
        ...
        //包含修改的视图文件
        include "./App/Admin/View/Student/StudentEditView.html";
    }
    public function update()
    {
        ...
        {
            $this->jump("id={$id}的记录更新成功！","?p=Admin&c=Student");
        }
        else{
            $this->jump("id={$id}的记录更新成功！","?p=Admin&c=Student");
        }
    ...
    public function delete()
    {
        ...
        {
            $this->jump("id={$id}的记录删除成功","?p=Admin&c=Student");
        }
        else
        {
            $this->jump("id={$id}的记录删除失败","?p=Admin&c=Student");

        }
    }
    public function add()
    {
        include "./App/Admin/View/Student/StudentAddView.html";
    }
